...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func checkFirstLuanch(){
        if (UserDefaults.standard.bool(forKey: "appLaunchedBefore")){
            ...
            UserDefaults.standard.setValue("no font", forKey: "topTextfieldFontType")
            UserDefaults.standard.setValue("no font", forKey: "bottomTextfieldFontType")
